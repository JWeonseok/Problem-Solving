...
public class No15644_구슬탈출3 {
	...
	static void Move(int dir) {		
		...
		if (!(balls.rx == rx && balls.ry == ry && balls.bx == bx && balls.by == by)) {
			Balls newBalls = new Balls(rx, ry, bx, by);
			newBalls.sb = new StringBuilder(balls.sb);
			newBalls.sb.append(d[dir]);
			q.offer(newBalls);
		}
	}
